    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('store_order')); ?>" method="POST" id="add_user_form" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        <div class="col-4">
                            ...
                            <div style="color:red;"><?php echo e($errors->first('fname')); ?></div>
                        </div>
                        <div class="col-4">
                            ...
                            <div style="color:red;"><?php echo e($errors->first('lname')); ?></div>
                        </div>
                        <div class="col-4">
                    ...
                    <div class="row">
                        <div class="col-4">
                            ...
                            <input type="text" name="email" placeholder="example@gmail.com" value="<?php echo e(old('email')); ?>"
                                   class="form-control" id="email" required>
                            <div style="color:red;"><?php echo e($errors->first('email')); ?></div>
                        </div>
                        <div class="col-4">
                            <label class="form-label mt-3 mb-0">Date of Birth *</label>
                            <input type="date" name="dob" value="<?php echo e(old('dob')); ?>" class="form-control" id="inputDob" required>
                            <div style="color:red;"><?php echo e($errors->first('dob')); ?></div>
                        </div>
                        <div class="col-4">
                            <label class="form-label mt-3 mb-0">Your Country *</label>
                            <select name="country" class="form-select" id="country" required>
                                <?php $__currentLoopData = getCountries(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option data-country-code="<?php echo e($country['phone_code']); ?>" value="<?php echo e($index); ?>"><?php echo e($country['name']); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <div style="color:red;"><?php echo e($errors->first('country')); ?></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-4">
                            <label class="form-label mt-3 mb-0">Passport Number *</label>
                            <input type="text" name="passport_number" placeholder="AB1234567" value="<?php echo e(old('passport_number')); ?>"
                                   class="form-control" id="passport_number" required>
                            <div style="color:red;"><?php echo e($errors->first('passport_number')); ?></div>
                        </div>
                        <div class="col-4">
                            <label class="form-label mt-3 mb-0">Passport Issue Date *</label>
                            <input type="date" name="passport_issue" value="<?php echo e(old('passport_issue')); ?>"
                                   class="form-control" id="passport_issue" required>
                            <div style="color:red;"><?php echo e($errors->first('passport_issue')); ?></div>
                        </div>
                        <div class="col-4">
                            <label class="form-label mt-3 mb-0">Passport Expiry Date *</label>
                            <input type="date" name="passport_expiry" value="<?php echo e(old('passport_expiry')); ?>"
                                   class="form-control" id="passport_expiry" required>
                            <div style="color:red;"><?php echo e($errors->first('passport_expiry')); ?></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-4">
                            <label class="form-label mt-3 mb-0">No of Applicants *</label>
                            <input type="text" name="applicants" placeholder="For Required Applicants" value="<?php echo e(old('applicants')); ?>"
                                   class="form-control" id="applicants" required>
                            <div style="color:red;"><?php echo e($errors->first('applicants')); ?></div>
                        </div>
                        <div class="col-4">
                            ...
                            <div style="color:red;"><?php echo e($errors->first('visa_type')); ?></div>
                        </div>
                        <div class="col-4">
                            <label class="form-label mt-3 mb-0">No of Days Required *</label>
                            <input type="text" name="days_required" placeholder="Input Required Days" value="<?php echo e(old('days_required')); ?>"
                                   class="form-control" id="days_required" required>
                            <div style="color:red;"><?php echo e($errors->first('days_required')); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-4">
                            ...
                            <div class="row">
                                ...
                                <input type="text" name="mobile_number" placeholder="000 1234567" value="<?php echo e(old('mobile_number')); ?>"
                        ...
                        <div class="col-4">
                            ...
                            <input type="date" name="arrival_date" value="<?php echo e(old('arrival_date')); ?>"
                                   class="form-control" id="arrival_date" required>
                            <div style="color:red;"><?php echo e($errors->first('arrival_date')); ?></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-4">
                            ...
                            <div style="color:red;"><?php echo e($errors->first('passport_copy')); ?></div>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\blog.com\resources\views/order_form.blade.php ENDPATH**/ ?>