                    ...
                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="pt-4 pb-2">
                                    <h5 class="card-title text-center pb-0 fs-4">Register as Admin</h5>
                                    <p class="text-center small">Enter your personal details to create account</p>
                                </div>

                                <form class="row g-3 needs-validation" action="<?php echo e(route('admin_register')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <div class="col-12">
                                        <label for="yourName" class="form-label">Your Name</label>
                                        <input type="text" name="name" value="<?php echo e(old('name')); ?>" class="form-control" id="yourName" required>
                                        <div style="color:red;"><?php echo e($errors->first('name')); ?></div>
                                    </div>

                                    <div class="col-12">
                                        <label for="yourEmail" class="form-label">Your Email</label>
                                        <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="form-control" id="yourEmail" required>
                                    ...
                                    <div class="col-12">
                                        <p class="small mb-0">Already have an account? <a href="<?php echo e(url('login')); ?>">Login</a></p>
                                    </div>
                                </form>
...
<?php /**PATH C:\xampp\htdocs\blog.com\resources\views/auth/admin_register.blade.php ENDPATH**/ ?>