                    ...
                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <form class="row g-3 needs-validation" action="<?php echo e(route('auth_login')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <div class="col-12">
...
<?php /**PATH C:\xampp\htdocs\blog.com\resources\views/auth/login.blade.php ENDPATH**/ ?>