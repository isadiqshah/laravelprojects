                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="" method="POST" id="add_user_form">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="name" value="<?php echo e(old('name')); ?>" class="form-control" required id="inputNanme4">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="meta_title" value="<?php echo e(old('meta_title')); ?>" class="form-control" required >
                            ...
                            <div class="col-12">
                                ...
                                <label>
                                    <select class="form-control" name="is_menu">
                                        <option <?php echo e((old('status') === 0) ? 'selected' : ''); ?> value="0">No</option>
                                        <option <?php echo e((old('status') === 1) ? 'selected' : ''); ?> value="1">Yes</option>
                                    </select>
                                </label>
                            </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blog.com\resources\views/backend/category/add.blade.php ENDPATH**/ ?>