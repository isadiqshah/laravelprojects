...
function getCountries()
{
    return [
        ...
        'AQ' => ['name' => 'Antarctica', 'phone_code' => null],
        ...
        'BV' => ['name' => 'Bouvet Island', 'phone_code' => null],
        'BR' => ['name' => 'Brazil', 'phone_code' => '+55'],
        'IO' => ['name' => 'British Indian Ocean Territory', 'phone_code' => null],
        ...
        'CX' => ['name' => 'Christmas Island', 'phone_code' => null],
        'CC' => ['name' => 'Cocos (Keeling) Islands', 'phone_code' => null],
        ...
        'TF' => ['name' => 'French Southern Territories', 'phone_code' => null],
        ...
        'HM' => ['name' => 'Heard Island and McDonald Islands', 'phone_code' => null],
        ...
        'KP' => ['name' => 'Korea, Democratic People\'s Republic', 'phone_code' => '+850'],
        ...
        'PN' => ['name' => 'Pitcairn', 'phone_code' => '+870'],
        ...
        'GS' => ['name' => 'South Georgia and the South Sandwich Islands', 'phone_code' => null],
        ...
        'UM' => ['name' => 'United States Minor Outlying Islands', 'phone_code' => null],
        ...
        'VG' => ['name' => 'Virgin Islands, British', 'phone_code' => '+1'],
        'VI' => ['name' => 'Virgin Islands, U.S.', 'phone_code' => '+1'],
