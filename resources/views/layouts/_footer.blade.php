...
>
    <div class="row pt-5">
        <div class="col-lg-4 col-md-6 mb-5">
            <a href="{{ route('home') }}" class="navbar-brand font-weight-bold text-secondary" style="font-size: 50px; height: 120px;">
                <img src="{{ asset('front/img/logoFFF.svg') }}" alt="Your Logo"
        ...
        <div class="col-lg-2 col-md-6 mb-5">
            ...
            <div class="d-flex flex-column justify-content-start">
                ...
                <a class="text-white mb-2" href="{{ route('gallery') }}"><i class="fa fa-angle-right mr-2"></i>Gallery</a>
                <a class="text-white mb-2" href="{{ route('blog') }}"><i class="fa fa-angle-right mr-2"></i>Our Blog</a>
                <a class="text-white" href="{{ route('contact') }}"><i class="fa fa-angle-right mr-2"></i>Contact Us</a>
                <a class="text-white" href="{{ route('contact') }}"><i class="fa fa-angle-right mt-2 mr-2"></i>FAQs</a>
            </div>
        </div>
        <div class="col-lg-2 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    @foreach(@$getCategoryHeader as $CategoryHeader)
                        <a href="{{ route('blog_detail', $CategoryHeader->slug) }}"
                           class="text-white  @if(Request::segment(3) == $CategoryHeader->slug) active @endif">
                            <i class="fa fa-angle-right mt-2 mr-2"></i>
                            {{ $CategoryHeader->name }}</a>
                    @endforeach
                </div>
        </div>
    ...
    <div
        ...
        <p class="m-0 text-center text-white">
            © {{ date('Y') }} Copyright:
            <a class="text-primary font-weight-bold" href="{{ route('home') }}">SadiqShah</a>.
            All Rights Reserved.
        </p>
    </div>
</div>
