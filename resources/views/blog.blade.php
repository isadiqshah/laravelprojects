                ...
                <div class="col-lg-4 mb-4">
                    <div class="card border-0 shadow-sm mb-2">
                        ...
                        <div class="card-body bg-light text-center p-4">
                            ...
                            <a href="{{ route('blog_detail', ['slug' => $value->slug]) }}">
                                <h4 class="">{!! strip_tags(Str::substr($value->title,0,60)) !!}</h4>
                            </a>
                            <div class="d-flex justify-content-center mb-3">
                                <small class="mr-3"><i class="fa fa-user text-primary"></i> {{ $value->user_name }}</small>
                                <small class="mr-3">
                                    <a href="{{ route('blog_detail', ['slug' => $value->slug]) }}"><i class="fa fa-folder text-primary"></i> {{ $value->category_name }}</a>
                                </small>
                            ...
                            <a href="{{ route('blog_detail', ['slug' => $value->slug]) }}" class="btn btn-primary px-4 mx-auto my-2"
                            >Read More</a
                            >
                        </div>
                    </div>
