    ...
    <div style="background-color: #f4f4f4; padding: 30px;">
        ...
        <!-- Button -->
        <a href="{{ route('order_feedback', ['order_id'=>$order_id])}}" style="display: inline-block; background-color: #007bff; color: #fff; text-decoration: none; padding: 10px 20px; border-radius: 5px;">Leave Feedback</a>

        <p style="color: #666;">Best regards,<br>{{ config('app.name') }}</p>
    </div>
