            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Vertical Form -->
                        <form class="row g-3" action="{{ route('update_slider', ['id' => $slider->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control tinymce-editor" name="description">{{ $slider->description }}</textarea>
                            </div>
